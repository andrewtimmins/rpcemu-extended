...
function(rpcemu_check_wx_webrequest inc_dirs defs)
    ...
    if(NOT RPCEMU_WX_HAS_WEBREQUEST)
        message(FATAL_ERROR
            ...
            "Windows, NSURLSession on macOS. wxWidgets turns wxUSE_WEBREQUEST "
            "off silently when its own configure finds none, and some "
            "distributions ship it that way.\n"
            "Known cases, checked against the packages themselves:\n"
            "  Debian 12 bookworm, and Raspberry Pi OS built on it: "
            "libwxgtk3.2-dev is 3.2.2 with wxUSE_WEBREQUEST 0. Installing "
            "libcurl will not help - the library is already built. You need "
            "wxWidgets built from source with libcurl4-openssl-dev present, "
            "or a newer distribution.\n"
            "  Debian 13 trixie (3.2.8) and Ubuntu 24.04: enabled, nothing to "
            "do.\n"
