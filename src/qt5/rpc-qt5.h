...
signals:
	...
	void debugger_state_changed_signal();
...
public slots:
	...
	void debugger_step();
	void debugger_step_n(quint32 instruction_count);
	void debugger_add_breakpoint(quint32 address);
	void debugger_remove_breakpoint(quint32 address);
	void debugger_clear_breakpoints();
	void debugger_add_watchpoint(quint32 address, quint32 size, bool on_read, bool on_write);
	void debugger_remove_watchpoint(quint32 address, quint32 size, bool on_read, bool on_write);
	void debugger_clear_watchpoints();
