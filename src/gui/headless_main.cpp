...
void HeadlessPrintUsage(const char *argv0)
{
	...
	HeadlessOutput(
	    ...
	    "  --vnc-port <n>        VNC port for this instance, overriding the settings\n"
	    "                        file. Needed when running more than one emulator on\n"
	    "                        a host, since the setting is per installation.\n"
	    "  --hostcmd-socket <spec>\n"
	    "                        HostCmd socket for this instance: a path, or a bare\n"
	    "                        port for TCP on localhost.\n"
	    "  --debug-socket <spec>\n"
	    "                        DebugCmd socket for this instance, same forms.\n"
	    ...
	    "                        HardDisc4 hard disc.\n"
	    "  --fetch-riscos-name <name>\n"
	    "                        With --fetch-riscos, name the machine this instead\n"
	    "                        of deriving a name from the RISC OS version.\n"
