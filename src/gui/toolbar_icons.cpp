...
wxBitmap ToolbarIconResume(const wxSize &size)
{
	return SvgIcon(resume_svg, size);
}

wxBitmap ToolbarIconSuspend(const wxSize &size)
{
	return SvgIcon(suspend_svg, size);
}
