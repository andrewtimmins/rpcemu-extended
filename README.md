...
| `--fetch-riscos-name <name>`     | With `--fetch-riscos`, name the machine this instead of deriving a name from the RISC OS version. Also accepts `--fetch-riscos-name=<name>`.                                                                                                                                                                                                                       |
...
| `--pkg-info <name>`              | Show everything the catalogue holds about one package, and exit. Also accepts `--pkg-info=<name>`.                                                                                                                                                                                                                                                                  |
| `--pkg-install <name>`           | Install a package. Needs `--pkg-machine`. Also accepts `--pkg-install=<name>`.                                                                                                                                                                                                                                                                                      |
| `--pkg-remove <name>`            | Remove a package. Needs `--pkg-machine`. Also accepts `--pkg-remove=<name>`.                                                                                                                                                                                                                                                                                        |
| `--pkg-machine <name>`           | Which machine's disc `--pkg-install` and `--pkg-remove` act on. Also accepts `--pkg-machine=<name>`.                                                                                                                                                                                                                                                                |
