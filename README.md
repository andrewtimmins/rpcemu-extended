...
| `docs/disassembly.md`            | The ARM disassembler: what it covers, the FPA and RISC OS SWI names, loading your own SWI names from a CSV file, and why it is not a library                                                                                                                                                                                                                   |
